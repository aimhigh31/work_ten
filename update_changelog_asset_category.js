...
async function updateChangeLogAssetCategory() {
  try {
    ...
    console.log('\n🔍 하드웨어 변경로그에서 자산분류 변경 조회 중...\n');

    // 3. 하드웨어 변경로그 조회 (자산분류 필드)
    ...
    console.log(`📊 자산분류 변경로그: ${changeLogs.length}개\n`);
