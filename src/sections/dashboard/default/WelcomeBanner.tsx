      ...
      <Grid container>
        <Grid size={{ md: 6, sm: 6, xs: 12 }}>
          <Stack sx={{ gap: 2, padding: 3 }}>
            <Typography variant="h2">Explore Redesigned Mainly</Typography>
            <Typography variant="h6">
              The Brand new User Interface with power of Material-UI Components. Explore the Endless possibilities with Mainly.
            </Typography>
            <Box sx={{ pt: 1.5 }}>
              <Button
                variant="outlined"
