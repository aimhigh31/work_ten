...
const Technologies = [
  ...
  // },
  {
    ...
    description: 'Access all components of Mainly in one place to make your development work easier.',
        ...
        <Grid size={12}>
          <Grid container spacing={2} sx={{ justifyContent: 'center', textAlign: 'center', marginBottom: 3, paddingTop: 3 }}>
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              ...
              >
                <Typography>Mainly caters to the needs of both developers and designers, whether they are beginners or experts.</Typography>
              </motion.div>
            </Grid>
          </Grid>
        </Grid>
