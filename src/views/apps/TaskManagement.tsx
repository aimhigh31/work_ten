...
const TaskEditDialog = dynamic(() => import('components/TaskEditDialog'), {
  ssr: false,
  loading: () => null
});
...
export default function TaskManagement() {
  ...
  const { tasks: supabaseTasks, loading: tasksLoading, updateTask, addTask: addTaskToDb, deleteTask: deleteTaskFromDb } = useSupabaseTaskManagement();

  // 통합 로딩 상태 (모든 필수 데이터가 로드될 때까지)
  const isInitialLoading = usersLoading || departmentsLoading || masterCodeLoading || tasksLoading;
