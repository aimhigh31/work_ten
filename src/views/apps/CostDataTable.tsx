                  ...
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <Box sx={{ flexGrow: 1 }}>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        {material.size} • {new Date(material.uploadDate).toLocaleDateString('ko-KR')}
                      </Typography>
                    </Box>
                    ...
                    <Box sx={{ display: 'flex', gap: 0.5 }}>
                      {editingMaterialId === material.id ? (
                        <>
                          <IconButton size="small" onClick={onSaveEditMaterial} color="primary" title="저장">
                            <Edit size={16} />
                          </IconButton>
                          <IconButton size="small" onClick={onCancelEditMaterial} color="default" title="취소">
                            <CloseCircle size={16} />
                          </IconButton>
                        </>
                      ) : (
                        <>
                          <IconButton size="small" onClick={() => onDownloadMaterial(material)} color="primary" title="다운로드">
                          ...
                          <IconButton size="small" onClick={() => onDeleteMaterial(material.id)} color="error" title="삭제">
                            <Trash size={16} />
                          </IconButton>
                        </>
                      )}
