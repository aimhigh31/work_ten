import { VOCData, VOCStatus, VOCRequestType } from 'types/voc';
...
// 상태별 색상 매핑 (VOCDataTable에서 사용)
export const vocStatusColors = statusColors;

// 팀별 색상 매핑
export const vocTeamColors = teamColors;

// 요청유형별 색상 매핑
export const vocRequestTypeColors = requestTypeColors;
