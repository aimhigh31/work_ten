...
export const taskData: TaskData[] = [
  ...
  },
  {
    ...
    code: 'MAIN-TASK-24-003',
    team: '개발팀',
    department: 'IT',
    workContent: '데이터 보안 시스템 구축',
    status: '홀딩',
    assignee: '정우진',
